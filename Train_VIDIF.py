...
def get_args_parser():
    parser = argparse.ArgumentParser('TRM_swin training and evaluation script', add_help=False)
    ...
    parser.add_argument('--back_bone', default='PDFNet_swinB', type=str,
                        help='back_bone (default: TRM_swin)')
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/DATA/DIS-DATA/', type=str,
                        help='dataset path')
